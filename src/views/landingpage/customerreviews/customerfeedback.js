...
const CustomerReview = () => {
    return ( 
<div className="sectioncf">
        <div className="outerdiv">
                <h3 className="textcfheader">User <span id="colortext8"> Feedback</span>   
            <br/>
            <br/>
            ...
            <div className="div1 eachdiv">
                ...
                <p>“ I was an EMT for many years before I joined the bootcamp. I’ve been looking to make a transition and have heard some people who had an amazing experience here.”</p>
                </div>
            </div>
            ...
            <div className="div2 eachdiv">
                ...
                <p>“ I started as a total newbie with virtually no coding skills. I now work as a mobile engineer for a big company.”</p>
                </div>
            </div>
