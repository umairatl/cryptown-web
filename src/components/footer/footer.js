          ...
          <div className="futmob">
            ...
            <div className="footer-col" style={{ textAlign: "center" }}>
              ...
              <div className="social-links">
                <a
                  href="https://www.facebook.com/profile.php?id=100088488904187&mibextid=ZbWKwL"
                  target="_blank">
                  <FaFacebook />
                </a>
                <a
                  href="https://www.youtube.com/channel/UC3tyXlq9YgEE7072Xrbmedg"
                  target="_blank">
                  <FaYoutube />
                </a>
                <a
                  href="https://www.instagram.com/cryptownweb/"
                  target="_blank">
                  <FaInstagram />
                </a>
